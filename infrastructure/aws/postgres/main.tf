...
module "postgres" {
  ...
  name                = local.name
  db_name             = "postgres"
  db_instance_address = data.terraform_remote_state.GovChat.outputs.db_instance_address
  db_master_username  = data.terraform_remote_state.GovChat.outputs.db_master_username
  db_master_password  = data.terraform_remote_state.GovChat.outputs.db_master_password
