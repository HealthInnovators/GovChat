...
class SignInLinkSentPage(BasePage):
    @property
    def expected_page_title(self) -> str:
        return "Sign in - link sent - GovChat"


class SignInConfirmationPage(BasePage):
    EXPECTED_TITLE = "Sign in - confirmation - GovChat"
...
class DocumentUploadPage(SignedInBasePage):
    @property
    def expected_page_title(self) -> str:
        return "Upload a document - GovChat"
...
class DocumentDeletePage(SignedInBasePage):
    @property
    def expected_page_title(self) -> str:
        return "Remove document - GovChat"
...
class ChatsPage(SignedInBasePage):
    ...
    def wait_for_latest_message(self, role="GovChat") -> ChatMessage:
...
class PrivacyPage(BasePage):
    @property
    def expected_page_title(self) -> str:
        return "Privacy notice - GovChat"


class AccessibilityPage(BasePage):
    @property
    def expected_page_title(self) -> str:
        return "Accessibility statement - GovChat"


class SupportPage(BasePage):
    @property
    def expected_page_title(self) -> str:
        return "Support - GovChat"
