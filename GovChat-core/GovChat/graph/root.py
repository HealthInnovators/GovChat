...
from GovChat.graph.edges import (
...
from GovChat.graph.nodes.sends import build_document_chunk_send, build_document_group_send
...
def get_root_graph(
    ...
    """Creates the core GovChat graph."""
    builder = StateGraph(GovChatState)
