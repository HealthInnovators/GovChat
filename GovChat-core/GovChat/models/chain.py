...
CHAT_SYSTEM_PROMPT = (
    "You are an AI assistant called GovChat tasked with answering questions and providing information objectively."
)

CHAT_WITH_DOCS_SYSTEM_PROMPT = "You are an AI assistant called GovChat tasked with answering questions on user provided documents and providing information objectively."
...
class GovChatState(TypedDict):
    request: Required[GovChatQuery]
...
def get_prompts(state: GovChatState, prompt_set: PromptSet) -> tuple[str, str]:
