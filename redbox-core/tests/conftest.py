...
from GovChat.retriever import AllElasticsearchRetriever, ParameterisedElasticsearchRetriever
...
) -> Generator[GovChatChatTestCase, None, None]:
    test_case: GovChatChatTestCase = request.param
