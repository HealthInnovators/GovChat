...
from GovChat.api.format import format_documents
from GovChat.chains.components import get_tokeniser
from GovChat.models.chain import ChainChatMessage, GovChatState
from GovChat.models.errors import QuestionLengthError
from GovChat.models.chain import PromptSet, get_prompts
from GovChat.transform import flatten_document_state, to_request_metadata
...
def build_chat_prompt_from_messages_runnable(prompt_set: PromptSet, tokeniser: Encoding = None) -> Runnable:
    @chain
    def _chat_prompt_from_messages(state: GovChatState) -> Runnable:
        """
