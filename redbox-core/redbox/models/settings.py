...
class Settings(BaseSettings):
    """Settings for the GovChat application."""
    ...
    elastic_root_index: str = "GovChat-data"

    kibana_system_password: str = "GovChatpass"
    metricbeat_internal_password: str = "GovChatpass"
    filebeat_internal_password: str = "GovChatpass"
    heartbeat_internal_password: str = "GovChatpass"
    monitoring_internal_password: str = "GovChatpass"
    beats_system_password: str = "GovChatpass"
    ...
    bucket_name: str = "GovChat-storage-dev"
