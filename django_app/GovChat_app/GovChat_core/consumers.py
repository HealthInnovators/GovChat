...
from GovChat.models import Settings
from GovChat.models.chain import AISettings, ChainChatMessage, GovChatQuery, GovChatState
from GovChat.models.chat import MetadataDetail
from GovChat_app.GovChat_core import error_messages
from GovChat_app.GovChat_core.models import (
    Chat,
    ChatMessage,
    ChatMessageTokenUse,
    ChatRoleEnum,
...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    GovChat = GovChat(env=Settings(), debug=True)
