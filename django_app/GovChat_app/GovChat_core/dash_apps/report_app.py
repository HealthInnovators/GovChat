...
if __name__ == "__main__":
    ...
    os.environ.setdefault("DJANGO_SETTINGS_MODULE", "GovChat_app.settings")

    # Django still needs some setup in order to access database
    django.setup()

    app = Dash("GovChatReport")
else:
    from django_plotly_dash import DjangoDash

    app = DjangoDash("GovChatReport")

from GovChat_app.GovChat_core import models  # Must be imported after django.setup()
