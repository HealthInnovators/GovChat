...
def create_default_ai_settings(apps, schema_editor):
    AISettings = apps.get_model("GovChat_core", "AISettings")
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "chat_system_prompt",
                    models.TextField(
                        default="You are an AI assistant called GovChat tasked with answering questions and providing information objectively."
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        default="You are an AI assistant called GovChat tasked with answering questions on user provided documents and providing information objectively."
                    ),
                ),
                (
