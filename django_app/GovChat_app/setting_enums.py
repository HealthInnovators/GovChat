...
class Environment(StrEnum):
    ...
    DEV = ("DEV", False, ["GovChat-dev.ai.cabinetoffice.gov.uk", *ADDITIONAL_HOSTS])
    PREPROD = ("PREPROD", False, ["GovChat-preprod.ai.cabinetoffice.gov.uk", *ADDITIONAL_HOSTS])
    PROD = ("PROD", False, ["GovChat.ai.cabinetoffice.gov.uk", *ADDITIONAL_HOSTS])
