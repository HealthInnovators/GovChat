...
from GovChat_app.GovChat_core.models import Chat, ChatMessage, ChatRoleEnum, File, StatusEnum
...
@patch("GovChat_app.GovChat_core.models.File.delete_from_elastic")
@pytest.mark.django_db()
...
@patch("GovChat_app.GovChat_core.models.File.delete_from_s3")
@pytest.mark.django_db()
...
def test_reingest_files(uploaded_file: File, requests_mock: Mocker, mocker):
    ...
    # When
    with mocker.patch("GovChat.chains.ingest.VectorStore.add_documents", return_value=[]):
