...
from GovChat_app.GovChat_core.models import ChatMessage
from GovChat_app.GovChat_core.serializers import ChatMessageSerializer, ChatSerializer, UserSerializer
...
def test_chat_export(superuser: User, chat_message_with_rating: ChatMessage, client: Client):
    ...
    url = reverse("admin:GovChat_core_chat_changelist")
...
def test_user_upload(superuser: User, client: Client):
    ...
    # When
    url = URL(reverse("admin:GovChat_core_user_changelist")) / "import/"
