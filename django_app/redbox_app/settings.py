...
from GovChat_app.setting_enums import Classification, Environment
...
MIDDLEWARE = [
    ...
    "GovChat_app.GovChat_core.middleware.plotly_no_csp_no_xframe_middleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "django_permissions_policy.PermissionsPolicyMiddleware",
    "csp.middleware.CSPMiddleware",
    "GovChat_app.GovChat_core.middleware.nocache_middleware",
    "GovChat_app.GovChat_core.middleware.security_header_middleware",
    "django_plotly_dash.middleware.BaseMiddleware",
]

ROOT_URLCONF = "GovChat_app.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.jinja2.Jinja2",
        "DIRS": [
            BASE_DIR / "GovChat_app" / "templates",
            BASE_DIR / "GovChat_app" / "templates" / "auth",
        ],
        "OPTIONS": {
            "environment": "GovChat_app.jinja2.environment",
        },
    },
    {
...
WSGI_APPLICATION = "GovChat_app.wsgi.application"
ASGI_APPLICATION = "GovChat_app.asgi.application"
...
SITE_ID = 1
AUTH_USER_MODEL = "GovChat_core.User"
...
GovChat_VERSION = os.environ.get("GovChat_VERSION", "not set")
